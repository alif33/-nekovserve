                ...
                <div className="container my-5 pb-5">
                    ...
                    <div className="align-items-center d-flex gx-0 gx-md-5 gy-5 row">
                        <div className="col-6 col-md-3 offset-md-0">
                            <Link href="https://solanart.io/collections/nekoverse">
                                <a className="w-100 px-3 px-md-0">
                                    <img className="w-100" src="/images/partner/solanart.png" alt="/resources/home/images/nekos/partners/solanart.png" />
                                </a>
                            </Link>
                        </div>
                        <div className="col-6 col-md-3 offset-md-0">
                            <a href="https://www.magiceden.io/marketplace/nekoverse" className="w-100 px-3 px-md-0">
                                <img className="w-100" src="/images/partner/me.svg" />
                            </a>
                        </div>
                        <div className="col-6 col-md-3 offset-md-0">
                            <a href="https://ftx.com/vi/nfts/collection/Nekoverse/25/1" className="w-100 px-3 px-md-0">
                                <img className="w-100" src="/images/partner/ftx.svg" alt="/image/partner/ftx.svg" />
                            </a>
                        </div>
                        <div className="col-6 col-md-3 offset-md-0">
                            <a href="https://solsea.io/collection/61a7b0d8e3df38d9cb88c9e9" className="w-100 px-3 px-md-0">
                    ...
                    <div className="align-items-center d-flex justify-content-center mt-5 flex-column text-white">
                        ...
                        <div className="col-8 col-md-3 offset-0 offset-md-0">
                            <a href="https://solscan.io/collection/3b2ccd352b8afc78df46c80141e3682c05c44a86da99b2e8325faeeb5956bd45#trades" className="w-100 px-3 px-md-0">
